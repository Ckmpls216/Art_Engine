...
const ImageLayersGeneratorInterface_1 = require("../../interfaces/generators/ImageLayersGeneratorInterface");
const ItemAttributesGeneratorInterface_1 = require("../../interfaces/generators/ItemAttributesGeneratorInterface");
const ImageLayersInput_1 = require("../inputs/ImageLayersInput");
        ...
        while (uid <= this.endIndex) {
            ...
            for (const attributeName of Object.keys(itemAttributes)) {
                ...
                for (const edgeCaseUid of Object.keys(option.edgeCases)) {
                    const [matchingTrait, matchingValue] = edgeCaseUid.split(ImageLayersInput_1.EDGE_CASE_UID_SEPARATOR);
            ...
            items[uid.toString()] = [
                {
                    kind: ItemAttributesGeneratorInterface_1.ITEM_ATTRIBUTES_GENERATOR_INTERFACE_V1,
                    data: {
                        dna: itemDna,
                ...
                {
                    kind: ImageLayersGeneratorInterface_1.IMAGE_LAYERS_GENERATOR_INTERFACE_V1,
                    data: {
                        assets: itemAssets,
                    },
                },
